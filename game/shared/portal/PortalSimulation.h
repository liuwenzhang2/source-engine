...
public:
	...
	CPortalSimulator* GetPortalSimulator() { return m_pOwningSimulator; }
...
#endif // GAME_DLL
	CPSCollisionEntity* GetLinkedPortal() { return (CPSCollisionEntity*)GetEnginePortal()->AsEngineObject()->GetOuter(); }
private:
...
public:
	...
	int					GetPortalSimulatorGUID( void ) const { return pCollisionEntity->GetEnginePortal()->GetPortalSimulatorGUID(); };
#endif
...
{
	return pCollisionEntity->GetEnginePortal()->IsReadyToSimulate();
}

inline bool CPortalSimulator::IsActivedAndLinked(void) const
{
	return pCollisionEntity->GetEnginePortal()->IsActivedAndLinked();
}

inline bool CPortalSimulator::IsSimulatingVPhysics( void ) const
{
	return pCollisionEntity->GetEnginePortal()->IsSimulatingVPhysics();
}
