...
{
	CRotorWashEmitter *pEmitter = (CRotorWashEmitter *)EntityList()->CreateEntityByName( "env_rotorwash_emitter" );
	...
	pEmitter->GetEngineObject()->FollowEntity(pOwner ? pOwner->GetEngineObject() : NULL);
