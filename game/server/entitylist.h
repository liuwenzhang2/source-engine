...
public:
	...
	int					GetMoveableOwnedEntities(CBaseEntity** pEntsOut, int iEntOutLimit) const; //gets owned entities that aren't either world or static props. Excludes fake portal ents such as physics clones
