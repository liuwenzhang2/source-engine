	...
	)
{
	...
	{
		ICollideable *pEnt = serverEntitylist->GetServerEntity(pTo->m_nEntityIndex)->GetCollideable();
		ICollideable *pClientEnt = serverEntitylist->GetServerEntity(u.m_nClientEntity)->GetCollideable();
		if ( pEnt && pClientEnt )
		{
